...
// 722 objetos · 8974 líneas · cobertura 100.0% del archivo
...
export const CATEGORIAS: Categoria[] = [
  { id: 'tabla', label: 'Tablas', color: '#3f6fd6', n: 57 },
  { id: 'tipo', label: 'Tipos ENUM', color: '#0f8a94', n: 21 },
  { id: 'vista', label: 'Vistas', color: '#2a9468', n: 8 },
  { id: 'funcion', label: 'Funciones', color: '#8b52d9', n: 55 },
  { id: 'trigger', label: 'Triggers', color: '#b5791b', n: 42 },
  { id: 'restriccion', label: 'Llaves y restricciones', color: '#c2504b', n: 71 },
  { id: 'fk', label: 'Claves foráneas', color: '#a1568c', n: 111 },
  { id: 'indice', label: 'Índices', color: '#5a6474', n: 51 },
  { id: 'rls', label: 'Seguridad por fila', color: '#3a3229', n: 299 },
...
export const OBJETOS: Objeto[] = [
  ...
  },
  {
    ...
    linea: 3950,
    claves: 'configuracion_id restriccion_id peso CONSTRAINT',
    params: [],
    pasos: [],
  ...
  },
  {
    ...
    linea: 3962,
    claves: 'id nombre tiempo_maximo_generacion_ms maximo_iteraciones tolerancia_violaciones_blandas esta_activa creado_en actualizado_en CONSTRAINT CONSTRAINT CONSTRAINT',
    params: [],
    pasos: [],
  ...
  },
  {
    ...
    linea: 4439,
    claves: 'id nombre descripcion peso es_dura esta_activa CONSTRAINT',
    params: [],
    pasos: [],
  ...
  },
  {
    ...
    linea: 4574,
    claves: 'id horario_id curso_id cohorte_id motivo_no_asignacion recursos_faltantes sugerencia_resolucion creado_en CONSTRAINT',
    params: [],
    pasos: [],
  ...
  },
  {
    ...
    detalle: '',
    nota: '19 columnas · borrado lógico',
    tabla: 'sugerencias_seccion',
    linea: 4591,
    claves: 'id horario_id cohorte_id curso_id matricula_detectada capacidad_maxima_disponible seccion_sugerida motivo estado solicitada_por_id resuelta_por_id resuelta_en creado_en eliminado_en CONSTRAINT CONSTRAINT CONSTRAINT CONSTRAINT CONSTRAINT',
    params: [],
    pasos: [],
...
$$;`,
  },
  {
    ...
    detalle: 'Al motor no le sirven franjas: necesita bloques. La expansión ocurre aquí, una sola vez, y no en cada corrida.',
    nota: 'devuelve jsonb · plpgsql · escribe',
    tabla: '',
    linea: 1917,
...
$$;`,
  },
  {
    ...
    detalle: '',
    nota: 'devuelve void · plpgsql · escribe',
    tabla: '',
    linea: 1826,
...
$$;`,
  },
  {
    ...
    nota: 'devuelve integer · plpgsql · escribe',
    tabla: '',
    linea: 2012,
...
--`,
  ...
  },
  {
    ...
    params: [],
    pasos: [],
    sql: `CREATE POLICY api_planes_leer ON horarios.generaciones FOR SELECT TO authenticated USING ((horarios.usuario_actual_tiene_permiso('planes'::text, 'leer'::text) OR horarios.usuario_actual_tiene_permiso('consultas'::text, 'leer'::text) OR horarios.usuario_actual_tiene_permiso('motor'::text, 'generar'::text) OR horarios.usuario_actual_tiene_permiso('reportes'::text, 'exportar'::text)));`,
  },
  {
  ...
  },
  {
    ...
    params: [],
    pasos: [],
    sql: `CREATE POLICY api_planes_leer ON horarios.mensajes_generacion FOR SELECT TO authenticated USING ((horarios.usuario_actual_tiene_permiso('planes'::text, 'leer'::text) OR horarios.usuario_actual_tiene_permiso('consultas'::text, 'leer'::text) OR horarios.usuario_actual_tiene_permiso('motor'::text, 'generar'::text) OR horarios.usuario_actual_tiene_permiso('reportes'::text, 'exportar'::text)));`,
  },
  {
  ...
  },
  {
    ...
    params: [],
    pasos: [],
    sql: `CREATE POLICY api_planes_leer ON horarios.sesiones_no_asignadas FOR SELECT TO authenticated USING ((horarios.usuario_actual_tiene_permiso('planes'::text, 'leer'::text) OR horarios.usuario_actual_tiene_permiso('consultas'::text, 'leer'::text) OR horarios.usuario_actual_tiene_permiso('motor'::text, 'generar'::text) OR horarios.usuario_actual_tiene_permiso('reportes'::text, 'exportar'::text)));`,
  },
  {
